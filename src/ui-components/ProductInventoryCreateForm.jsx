...
export default function ProductInventoryCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setQuanlity(initialValues.quanlity);
    setCreated_at(initialValues.created_at);
    setModified_at(initialValues.modified_at);
    setErrors({});
  };
  const validations = {
    quanlity: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ProductInventory(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ProductInventoryCreateForm")}
      {...rest}
    >
      <TextField
        label="Quanlity"
